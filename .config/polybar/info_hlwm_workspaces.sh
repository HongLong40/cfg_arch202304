            ...
            for i in "${tags[@]}" ; do
                ...
                case ${i:0:1} in
                    '#')
                        ...
                        echo "%{B#355B1A}" # Add your formatting tags for empty workspaces
                        ;;
                    ':')
                        # : the tag is not empty
                        # TODO Add your formatting tags for occupied workspaces
                        echo "%{B#5B1A35}" # Add your formatting tags for empty workspaces
                        ;;
                    '!')
                    ...
                    *)
                        ...
                        echo "%{F#AAAAAA}%{B-}" # Add your formatting tags for empty workspaces
                        ;;
                esac
